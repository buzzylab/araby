...
# Tag Components
for REMOTE in araby-charset araby-compress araby-date araby-gender araby-glyphs araby-hiero araby-identifier araby-keyswap araby-maketime araby-normalize araby-numbers araby-query araby-salat araby-soundex araby-standard araby-stemmer araby-strtotime araby-summarize araby-transliteration araby-wordtag
do
    echo ""
    echo ""
    ...
    REMOTE_URL="git@github.com:buzzylab/$REMOTE.git"
